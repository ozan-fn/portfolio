//#region .svelte-kit/adapter-bun/chunks/render-context.js
const escaped = {
	"<": "\\u003C",
	"\\": "\\\\",
	"\b": "\\b",
		...
		switch (type) {
			...
			case "BigUint64Array": {
				...
				if (!names.has(thing.buffer)) {
					...
					str2 += `([${array}])`;
				} else str2 += `(${stringify(thing.buffer)})`;
			...
			case "DataView": {
				...
				if (thing.byteLength !== thing.buffer.byteLength) str2 += `,${thing.startOffset},${thing.byteLength}`;
				return str2 + ")";
			}
...
//#endregion
//#region .svelte-kit/adapter-bun/chunks/renderer.js
...
//#endregion
export { run as $, bind_props as A, get_descriptor as B, WAS_MARKED as C, attr_class as D, attr as E, element as F, index_of as G, hasContext as H, ensure_array_like as I, is_passive_event as J, is_array as K, escape_html as L, deferred as M, define_property as N, attr_style as O, derived as P, render as Q, getAllContexts as R, USER_EFFECT as S, array_prototype as T, head as U, get_prototype_of as V, includes as W, object_prototype as X, noop as Y, props_id as Z, REACTION_IS_UPDATING as _, DESTROYING as a, clsx$1 as at, STATE_SYMBOL as b, EFFECT_PRESERVED as c, get_type as ct, HEAD_EFFECT as d, lifecycle_function_unavailable as dt, run_all as et, HYDRATION_ERROR as f, stringify_key as ft, MAYBE_DIRTY as g, MANAGED_EFFECT as h, valid_array_indices as ht, DESTROYED as i, stringify as it, clsx as j, attributes as k, EFFECT_TRANSPARENT as l, is_plain_object as lt, LEGACY_PROPS as m, uneval as mt, ATTACHMENT_KEY as n, spread_props as nt, DIRTY as o, DevalueError as ot, INERT as p, stringify_string as pt, is_extensible as q, CLEAN as r, ssr_context as rt, EAGER_EFFECT as s, enumerable_symbols as st, ASYNC as t, setContext as tt, ERROR_VALUE as u, is_primitive as ut, REACTION_RAN as v, array_from as w, UNINITIALIZED as x, STALE_REACTION as y, getContext as z };

//# sourceMappingURL=renderer-CoNnoy0x.js.map