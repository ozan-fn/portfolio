import { B as get_descriptor, C as WAS_MARKED, G as index_of, J as is_passive_event, K as is_array, M as deferred, N as define_property, P as derived, Q as render, S as USER_EFFECT, T as array_prototype, V as get_prototype_of, W as includes, X as object_prototype, Y as noop, _ as REACTION_IS_UPDATING, a as DESTROYING, b as STATE_SYMBOL, c as EFFECT_PRESERVED, et as run_all, f as HYDRATION_ERROR, g as MAYBE_DIRTY, i as DESTROYED, l as EFFECT_TRANSPARENT, m as LEGACY_PROPS, o as DIRTY, p as INERT, q as is_extensible, r as CLEAN, tt as setContext, u as ERROR_VALUE, v as REACTION_RAN, w as array_from, x as UNINITIALIZED, y as STALE_REACTION } from "./renderer-CoNnoy0x.js";
//#region node_modules/.pnpm/@sveltejs+kit@2.57.0_@opent_16bec9e7b121b55ae1a2611c2ed9ea41/node_modules/@sveltejs/kit/src/runtime/server/constants.js
...
//#endregion
//#region node_modules/.pnpm/@sveltejs+kit@2.57.0_@opent_16bec9e7b121b55ae1a2611c2ed9ea41/node_modules/@sveltejs/kit/src/exports/internal/server.js
/**
...
//#endregion
//#region .svelte-kit/adapter-bun/chunks/root.js
		...
		for (const batch of batches) {
			...
			if (others.length === 0) {
				...
				if (batch.#roots.length > 0) {
					batch.apply();
					for (var root2 of batch.#roots) batch.#traverse(root2, [], []);
					batch.#roots = [];
				}
				batch.deactivate();
			}
	...
	*/
	...
	error(error) {
		...
		queue_micro_task(() => {
			...
			if (result !== null && typeof result === "object" && typeof result.then === "function") result.then(
				handle_error_result,
				/** @param {unknown} e */
...
function schedule_possible_effect_self_invalidation(signal, effect, root2 = true) {
	...
	for (var i = 0; i < reactions.length; i++) {
		var reaction = reactions[i];
		if ((reaction.f & 2) !== 0) schedule_possible_effect_self_invalidation(
			/** @type {Derived} */
			reaction,
			effect,
			false
...
function update_reaction(reaction) {
	...
	try {
		...
		if (is_runes() && untracked_writes !== null && !untracking && deps !== null && (reaction.f & 6146) === 0) for (i = 0; i < untracked_writes.length; i++) schedule_possible_effect_self_invalidation(
			untracked_writes[i],
			/** @type {Effect} */
			reaction
		);
...
function depends_on_old_values(derived2) {
	...
	for (const dep of derived2.deps) {
		...
		if ((dep.f & 2) !== 0 && depends_on_old_values(
			/** @type {Derived} */
			dep
		)) return true;
	}
...
//#endregion
export { text_decoder as _, decode_pathname as a, with_request_store as b, normalize_path as c, validate_layout_server_exports as d, validate_page_exports as f, get_relative_path as g, base64_encode as h, decode_params as i, resolve as l, base64_decode as m, root as n, disable_search as o, validate_page_server_exports as p, safe_not_equal as r, make_trackable as s, on as t, validate_layout_exports as u, text_encoder as v, merge_tracing as y };

//# sourceMappingURL=root-hPyMpEOi.js.map