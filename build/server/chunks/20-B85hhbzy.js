...
const index = 20;
let component_cache;
const component = async () => component_cache ??= (await import("./_page.svelte-xHN5TMzN.js")).default;
const server_id = "src/routes/(protected)/dashboard/certificates/[id]/view/+page.server.ts";
const imports = [
	"_app/immutable/nodes/20.S-5-yX1a.js",
...
//# sourceMappingURL=20-B85hhbzy.js.map