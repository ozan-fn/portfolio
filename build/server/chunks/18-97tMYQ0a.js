...
const index = 18;
let component_cache;
const component = async () => component_cache ??= (await import("./_page.svelte-BASxE66f.js")).default;
const server_id = "src/routes/(protected)/dashboard/certificates/new/+page.server.ts";
const imports = [
	"_app/immutable/nodes/18.CKBUWneJ.js",
...
//# sourceMappingURL=18-97tMYQ0a.js.map