...
import { t as Arrow_up_right } from "./arrow-up-right-CnvAJa9B.js";
...
function _page($$renderer) {
	{
		let children = function($$renderer2) {
			$$renderer2.push(`<div class="w-full grid gap-6 md:grid-cols-2 lg:grid-cols-4"><div class="rounded-xl border bg-card p-6 shadow-sm"><div class="flex items-center justify-between space-y-0 pb-2"><h3 class="text-sm font-medium">Total Projects</h3> `);
			Briefcase($$renderer2, { class: "h-4 w-4 text-muted-foreground" });
			$$renderer2.push(`<!----></div> <div class="flex items-end justify-between"><div class="text-2xl font-bold">12</div> `);
			Button($$renderer2, {
				variant: "ghost",
				size: "sm",
				...
				children: ($$renderer3) => {
					...
					Arrow_up_right($$renderer3, { class: "ml-1 h-3 w-3" });
					$$renderer3.push(`<!---->`);
				},
				$$slots: { default: true }
			});
			$$renderer2.push(`<!----></div></div> <div class="rounded-xl border bg-card p-6 shadow-sm"><div class="flex items-center justify-between space-y-0 pb-2"><h3 class="text-sm font-medium">Blog Posts</h3> `);
			File_text($$renderer2, { class: "h-4 w-4 text-muted-foreground" });
			$$renderer2.push(`<!----></div> <div class="flex items-end justify-between"><div class="text-2xl font-bold">24</div> `);
			Button($$renderer2, {
				variant: "ghost",
				size: "sm",
				href: "/dashboard/blog",
			...
			$$renderer2.push(`<!----></div></div> <div class="rounded-xl border bg-card p-6 shadow-sm"><div class="flex items-center justify-between space-y-0 pb-2"><h3 class="text-sm font-medium">Categories</h3> `);
			Tag($$renderer2, { class: "h-4 w-4 text-muted-foreground" });
			$$renderer2.push(`<!----></div> <div class="flex items-end justify-between"><div class="text-2xl font-bold">8</div> `);
			Button($$renderer2, {
				variant: "ghost",
				size: "sm",
			...
			Button($$renderer2, {
				...
				children: ($$renderer3) => {
					...
					$$renderer3.push(`<!----> <span>New Project</span>`);
				},
				$$slots: { default: true }
			});
			$$renderer2.push(`<!----> `);
			Button($$renderer2, {
				...
				children: ($$renderer3) => {
					Plus($$renderer3, { size: 20 });
					$$renderer3.push(`<!----> <span>New Article</span>`);
				},
				$$slots: { default: true }
			});
...
//# sourceMappingURL=_page.svelte-CIoq8XIK.js.map