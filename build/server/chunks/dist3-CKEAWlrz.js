import { A as isDate, B as noop, D as isBigInt, E as freeze, F as isObject, L as isString, N as isNull, O as isBoolean, P as isNumber, R as isUndefined, a as DEFAULT_MIGRATION_LOCK_TABLE, c as IdentifierNode, f as ON_COMMIT_ACTIONS, i as CreateViewNode, j as isFunction, k as isBuffer, m as OperationNodeTransformer, o as DEFAULT_MIGRATION_TABLE, r as CreateTableNode, s as DefaultQueryCompiler, v as RawNode, w as WithSchemaPlugin, y as SchemableIdentifierNode, z as logOnce } from "./migrator-BXaPyuEm.js";
import { C as parseTable, D as sql, E as randomString, S as parseStringReference, T as provideControlledConnection, _ as isOperationNodeSource, a as Deferred, b as parseExpression, c as QueryCreator, d as SelectAllNode, f as SelectQueryNode, g as createQueryId, h as createFunctionModule, i as CompiledQuery, l as QueryExecutorBase, m as ValueNode, n as CaseNode, o as DynamicReferenceBuilder, p as ValueListNode, r as ColumnNode, s as DynamicTableBuilder, t as CaseBuilder, u as QueryNode, v as parseColumnName, w as parseValueBinaryOperationOrExpression, x as parseOrderedColumnName, y as parseDataTypeExpression } from "./compiled-query-CP8Dfx0D.js";
import { n as SqliteAdapter, r as SqliteQueryCompiler, t as DialectAdapterBase } from "./sqlite-adapter-DffUA32r.js";
import { s as createAdapterFactory } from "./factory-C4fZf0Dd.js";
import { t as capitalizeFirstLetter } from "./string-C8ioVQ62.js";
//#region .svelte-kit/adapter-bun/chunks/dist3.js
/**
* @internal
*/
...
var createKyselyAdapter = async (config) => {
	...
	if ("fileControl" in db) {
		const { BunSqliteDialect } = await import("./bun-sqlite-dialect-na--YwnN-CPtl8_yf.js");
	...
	if ("createSession" in db) {
		...
		if (DatabaseSync && db instanceof DatabaseSync) {
			const { NodeSqliteDialect } = await import("./node-sqlite-dialect-DHFlatRX.js");
			dialect = new NodeSqliteDialect({ database: db });
		}
	}
	if ("batch" in db && "exec" in db && "prepare" in db) {
		const { D1SqliteDialect } = await import("./d1-sqlite-dialect-C2B7YsIT-zwaK55jg.js");
...
//# sourceMappingURL=dist3-CKEAWlrz.js.map