import { T as escape_html, c as attr, pt as stringify, x as derived } from "./dev-D04rZKKe.js";
...
import { t as Crud_form_layout } from "./crud-form-layout-Db83ljr9.js";
			...
			$$renderer.push(`<!----> `);
			{
				function main($$renderer) {
					...
					Input($$renderer, {
						...
						name: "order",
						type: "number",
						value: data.project.order
					});
					$$renderer.push(`<!----></div> <div class="flex items-center space-x-2 pt-8"><input type="checkbox" id="featured" name="featured"${attr("checked", data.project.featured, true)} class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary"/> `);
					Label($$renderer, {
						for: "featured",
						children: ($$renderer) => {
...
//# sourceMappingURL=_page.svelte-Bs6XrOsg.js.map