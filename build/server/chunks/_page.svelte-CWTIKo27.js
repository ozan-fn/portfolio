import { h as head, e as escape_html, a as attr, o as ensure_array_like } from './index2-CKLX2A8l.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!----> ${escape_html(new Date(data.project.createdAt).toLocaleDateString("en-US", { month: "long", year: "numeric" }))}</div></div> <h1 class="text-4xl font-bold tracking-tight md:text-5xl">${escape_html(data.project.title)}</h1> <p class="text-xl text-muted-foreground">${escape_html(data.project.description)}</p></div> <div class="flex gap-3">`);
...
//# sourceMappingURL=_page.svelte-CWTIKo27.js.map
