import { E as attr, P as derived, U as head } from "./renderer-CoNnoy0x.js";
import { a as modeStorageKey, c as themeColors, i as lightClassNames, l as themeStorageKey, n as defineConfig, o as setInitialMode, r as disableTransitions, s as synchronousModeChanges, t as darkClassNames } from "./mode-BlOj8mZm.js";
...
function Mode_watcher_full($$renderer, $$props) {
	$$renderer.component(($$renderer2) => {
		...
		head("4uafmv", $$renderer2, ($$renderer3) => {
			if (themeColors2) {
				$$renderer3.push("<!--[0-->");
...
//# sourceMappingURL=_layout.svelte-BBmkA1p5.js.map