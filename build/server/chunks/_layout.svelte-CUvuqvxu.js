...
import { r as attr_class, f as bind_props, i as spread_props, c as setContext, p as props_id, j as attributes, d as derived, u as stringify, o as ensure_array_like, a as attr, e as escape_html, k as element, g as getContext } from './index2-CKLX2A8l.js';
import { C as Context, D as DOMContext, S as Separator, o as onDestroy, w as watch } from './separator-w2DSfCQY.js';
...
const createAnimatePresenceContext = (context) => {
  ...
  const unregisterChild = (key) => {
    ...
    inFlightExits += 1;
    requestAnimationFrame(() => {
      animate(clone, exitKeyframes, finalTransition).finished.catch(() => {
      }).finally(() => {
        try {
          clone.style.zIndex = "";
        } catch {
...
const resolveAnimate = (animate2, variants) => {
  if (animate2 === void 0)
    return void 0;
  if (typeof animate2 === "string")
    return resolveVariant(variants, animate2);
  return animate2;
};
...
function _MotionContainer($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (context && presenceDepth === 0 && !keyProp) {
      throw new Error('motion elements that are direct children of AnimatePresence must have a `key` prop. Example: <motion.div key="unique-id" />');
    }
    if (presenceDepth !== void 0) {
    ...
    const initialVariantValue = typeof animateProp === "string" ? animateProp : variantsProp && initialInheritedVariant || void 0;
    const localVariantStore = writable(initialVariantValue);
    ...
    const derivedAttrs = derived(() => ({
      ...
      style: mergeInlineStyles(
        initialKeyframes() && "pathLength" in initialKeyframes() && isLoaded === "mounting" ? `${styleProp || ""};visibility:hidden` : styleProp,
        ...
        isNotEmpty(initialKeyframes()) ? void 0 : resolvedAnimate()
      ),
      class: classProp
    }));
    if (isVoidTag()) {
      ...
      if (isSVGTag(String(tag))) {
        ...
        element($$renderer2, tag, () => {
          $$renderer2.push(`${attributes({ xmlns: SVG_NAMESPACE, ...derivedAttrs() })}`);
        });
      } else {
        $$renderer2.push("<!--[-1-->");
        element($$renderer2, tag, () => {
...
const motion = Object.fromEntries(Object.entries(html).map(([key, component]) => [key.toLowerCase(), component]));
...
function Sidebar($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    const menuItems = [
      ...
      { id: "blog", label: "Blog", icon: Pen_tool, path: "/blog" },
      {
        id: "contact",
        label: "Contact",
        icon: Mail,
    ...
    Avatar($$renderer2, {
      ...
      children: ($$renderer3) => {
        Avatar_image($$renderer3, { src: profile, alt: "Akhmad Fauzan" });
        $$renderer3.push(`<!----> `);
        ...
        Card_content($$renderer3, {
          ...
          children: ($$renderer4) => {
            ...
            Avatar($$renderer4, {
              ...
              children: ($$renderer5) => {
                Avatar_image($$renderer5, { src: profile, alt: "Akhmad Fauzan" });
                $$renderer5.push(`<!----> `);
            ...
            for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
              ...
              if (item.icon) {
                $$renderer4.push("<!--[-->");
                item.icon($$renderer4, {
                  class: `size-4.5 relative z-10 ${stringify(activeTab() === item.id ? "text-primary" : "group-hover:text-primary transition-colors")}`
                });
                $$renderer4.push("<!--]-->");
              } else {
                $$renderer4.push("<!--[!-->");
...
//# sourceMappingURL=_layout.svelte-CUvuqvxu.js.map
