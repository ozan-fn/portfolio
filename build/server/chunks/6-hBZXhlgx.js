...
const index = 6;
let component_cache;
const component = async () => component_cache ??= (await import("./_page.svelte-CZ4HjvJF.js")).default;
const server_id = "src/routes/(app)/certificates/+page.server.ts";
const imports = [
	"_app/immutable/nodes/6.DoonNvwW.js",
...
//# sourceMappingURL=6-hBZXhlgx.js.map