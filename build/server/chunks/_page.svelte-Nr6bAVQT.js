import { h as head, e as escape_html, o as ensure_array_like, q as attr_style, f as bind_props, i as spread_props, p as props_id, j as attributes, a as attr, r as attr_class, m as clsx, d as derived, t as run, u as stringify } from './index2-CKLX2A8l.js';
import { o as onDestroy, S as Separator, w as watch, C as Context, D as DOMContext } from './separator-w2DSfCQY.js';
import mqtt from 'mqtt';
import { t as tv, B as Button, c as cn } from './button-DsqoR_hA.js';
...
import { C as Card_header, a as Card_title, b as Card_description, c as Card_footer } from './card-title-33G8gCf4.js';
import { c as createBitsAttrs, a as createId, b as boxWith, d as attachRef, m as mergeProps, f as boolToStr, g as boolToEmptyStrOrUndef, h as isWritableSymbol, B as BoxSymbol, j as boxFrom, k as boxFlatten, t as toReadonlyBox, l as isBox, n as isWritableBox, o as boolToTrueOrUndef } from './create-id-D4tMQ4vo.js';
import { n as noop, E as END, i as isHTMLElement, a as isElementOrSVGElement, A as ARROW_LEFT, b as ARROW_RIGHT, c as ARROW_UP, d as ARROW_DOWN, H as HOME, S as SPACE, e as ENTER } from './noop-D2sDL339.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const connectMQTT = (room) => {
      ...
      client.on("message", (topic, message) => {
        ...
        if (data.type === "join") {
          ...
          players = players.map((p) => p.name === data.name ? {
            ...p,
    ...
    const startMultiplayerGame = () => {
      ...
      client?.publish(`ozan/colorgame/${roomId}`, JSON.stringify({ type: "start_game", targetColors: newTargets }));
    };
...
//# sourceMappingURL=_page.svelte-Nr6bAVQT.js.map
