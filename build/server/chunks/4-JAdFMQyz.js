...
const index = 4;
let component_cache;
const component = async () => component_cache ??= (await import("./_page.svelte-BxBWniKd.js")).default;
const server_id = "src/routes/(app)/+page.server.ts";
const imports = [
	"_app/immutable/nodes/4.ClTRUe14.js",
...
//# sourceMappingURL=4-JAdFMQyz.js.map