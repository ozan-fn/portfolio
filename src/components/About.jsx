    ...
    return (
        <>
            <div className="ml-4 mt-20 flex h-full max-w-xl flex-col gap-2.5 px-4 md:ml-20 lg:px-0">
                ...
                <ReactTyped
                    className="font-mono text-lg italic"
                    strings={[
                        "Dengan latar belakang pendidikan di bidang INFORMATIKA, saya memiliki kemampuan yang luas dalam pengembangan frontend dan backend. Saya mahir dalam penggunaan HTML, CSS, JavaScript, React.js, Node.js, Express.js, Linux, dan Docker, yang memungkinkan saya untuk membangun aplikasi web yang responsif dan dinamis.",
                    ]}
                />
                <hr className="my-4" />
