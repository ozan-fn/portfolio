...
import { $createParagraphNode, $getNodeByKey, $getSelection, $isRangeSelection, COMMAND_PRIORITY_EDITOR, COMMAND_PRIORITY_LOW, createCommand, KEY_ARROW_DOWN_COMMAND, KEY_ARROW_LEFT_COMMAND, KEY_ARROW_RIGHT_COMMAND, KEY_ARROW_UP_COMMAND, LexicalEditor } from "lexical";
import type { ElementNode, LexicalCommand, LexicalNode, NodeKey } from "lexical";

import { $createLayoutContainerNode, $isLayoutContainerNode, LayoutContainerNode } from "@/components/editor/nodes/layout-container-node";
...
export function InsertLayoutDialog({ activeEditor, onClose }: { activeEditor: LexicalEditor; onClose: () => void }): JSX.Element {
