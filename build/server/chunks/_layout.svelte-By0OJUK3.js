import { f as bind_props, c as setContext, i as spread_props, d as derived, j as attributes, m as clsx, u as stringify, g as getContext, a as attr, r as attr_class, p as props_id, ai as getAllContexts, o as ensure_array_like, e as escape_html } from './index2-CKLX2A8l.js';
import { t as tv, c as cn, B as Button } from './button-DsqoR_hA.js';
import { C as Context, w as watch, t as tick, m as mount, S as Separator, u as unmount, D as DOMContext, c as contains, g as getDocument, a as getWindow$1, d as defaultWindow } from './separator-w2DSfCQY.js';
import { n as noop, S as SPACE, e as ENTER, f as isBrowser, g as ESCAPE, i as isHTMLElement$1, h as isIOS, a as isElementOrSVGElement, j as isElement$1, k as isFocusVisible, l as isNotNull } from './noop-D2sDL339.js';
import { b as boxWith, s as simpleBox, c as createBitsAttrs, a as createId, p as getDataOpenClosed, d as attachRef, g as boolToEmptyStrOrUndef, m as mergeProps, q as executeCallbacks, r as composeHandlers, u as cssToStyleObj, v as styleToString } from './create-id-D4tMQ4vo.js';
import { o as on } from './root-BnY0kdZ5.js';
import { M as MediaQuery, S as SvelteMap, c as createSubscriber } from './index-server-_G0R5Qhl.js';
import { I as Icon } from './Icon-BSFcCQvO.js';
import { X } from './x-DmPya20-.js';
import { M as Mode_toggle } from './mode-toggle-CCIEuRJo.js';
import { a as authClient } from './auth-client-N-Lg9PmO.js';
import { g as goto } from './client-Dk1puGtQ.js';
import { p as page } from './index3-C80W_1XB.js';
    ...
    function $$render_inner($$renderer3) {
      Tooltip_provider($$renderer3, {
        children: ($$renderer4) => {
          if (Tooltip$1) {
            $$renderer4.push("<!--[-->");
            Tooltip$1($$renderer4, spread_props([
              restProps,
              {
                get open() {
                  return open;
...
function Admin_sidebar($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    const items = [
      { title: "Dashboard", url: "/dashboard", icon: Layout_dashboard },
      {
        title: "Projects",
        url: "/dashboard/projects",
        icon: Briefcase
      },
      { title: "Blog", url: "/dashboard/blog", icon: File_text },
                                        ...
                                        children: ($$renderer8) => {
                                          {
                                            let child = function($$renderer9, { props }) {
                                              $$renderer9.push(`<a${attributes({ href: item.url, ...props })}>`);
                                              if (item.icon) {
                                                $$renderer9.push("<!--[-->");
        ...
        if (Sidebar_inset) {
          ...
          Sidebar_inset($$renderer2, {
            children: ($$renderer3) => {
              ...
              $$renderer3.push(` `);
              Separator($$renderer3, { orientation: "vertical", class: "mr-2 h-4" });
...
//# sourceMappingURL=_layout.svelte-By0OJUK3.js.map
